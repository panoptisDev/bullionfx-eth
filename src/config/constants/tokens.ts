...
const BULL_TESTNET = new Token(
  ChainId.BSC_TESTNET,
  '0x589dce1954803B52b417182B026F71E40d138Ac2',
  18,
  'tBULL',
  'tBullionFX',
  'https://pancakeswap.finance/',
...
const GOLD_TESTNET = new Token(
  ChainId.BSC_TESTNET,
  '0x65cDfA26c6F96756655Bce813962485a3859e68F',
  18,
  'GOLD',
  'BullionFX Gold',
  'https://pancakeswap.finance/',
...
const TUSDC_TESTNET = new Token(
  ChainId.BSC_TESTNET,
  '0xE70b8Eef9011F0955756A5720BbaE3C6407DCE31',
  18,
  'tUSDC',
  'Test USDC Token',
  'https://www.centre.io/usdc',
...
export const USDC = {
  ...
  [ChainId.BSC_TESTNET]: TUSDC_TESTNET,
...
const BUSD_TESTNET = new Token(
  ChainId.BSC_TESTNET,
  '0x8B40946bf629219F901fADe9F29E086fFd95Aaba',
  18,
  'BUSD',
  'Binance USD',
  'https://www.paxos.com/busd/',
...
export const bscTestnetTokens = {
  ...
  syrup: new Token(
    ChainId.BSC_TESTNET,
    '0x88081Df8427ae3A3F23f7dcf19C0C90A94a11F2e',
    18,
    'SYRUP',
    'SyrupBar Token',
    'https://pancakeswap.finance/',
