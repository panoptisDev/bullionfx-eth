...
export const INFO_CLIENT_TESTNET = 'https://api.thegraph.com/subgraphs/name/enjoydream420/bull_test_exchange'
export const BLOCKS_CLIENT = 'https://api.thegraph.com/subgraphs/name/pancakeswap/blocks'
export const BLOCKS_CLIENT_TESTNET = 'https://api.thegraph.com/subgraphs/name/enjoydream420/bull_test_block'
