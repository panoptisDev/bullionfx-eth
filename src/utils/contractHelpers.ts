...
import masterchefTestnet from 'config/abi/masterchefTestnet.json'
...
export const getContract = (abi: any, address: string, chainId: number, signer?: Signer | Provider) => {
  const provider = chainId === ChainId.BSC_TESTNET ? bscTestnetRpcProvider : bscRpcProvider
...
export const getCakeContract = (chainId: number, signer?: Signer | Provider) => {
  return getContract(cakeAbi, chainId ? CAKE[chainId].address : CAKE[ChainId.BSC].address, chainId, signer) as Cake
}
...
export const getMasterchefContract = (chainId: number, signer?: Signer | Provider) => {
  const abi = chainId === ChainId.BSC ? masterChef : masterchefTestnet
  return getContract(abi, getMasterChefAddress(chainId), chainId, signer) as Masterchef
}
export const getMasterchefV1Contract = (signer?: Signer | Provider) => {
  const chainId = 56
  return getContract(masterChefV1, getMasterChefV1Address(), chainId, signer) as MasterchefV1
}
...
export const getCakeFlexibleSideVaultV2Contract = (signer?: Signer | Provider) => {
  const chainId = 56
  return getContract(cakeFlexibleSideVaultV2Abi, getCakeFlexibleSideVaultAddress(), chainId, signer) as CakeFlexibleSideVaultV2
}
...
export const getZapContract = (signer?: Signer | Provider) => {
  const chainId = 56
  return getContract(zapAbi, getZapAddress(), chainId, signer) as Zap
}

export const getIfoCreditAddressContract = (signer?: Signer | Provider) => {
  const chainId = 56
  return getContract(iCakeAbi, getICakeAddress(), chainId, signer) as ICake
}

export const getBCakeFarmBoosterContract = (chainId: number, signer?: Signer | Provider) => {
  return getContract(bCakeFarmBoosterAbi, getBCakeFarmBoosterAddress(chainId), chainId, signer) as BCakeFarmBooster
}
...
export const getBCakeProxyContract = (proxyContractAddress: string, signer?: Signer | Provider) => {
  const chainId = 56
  return getContract(bCakeProxyAbi, proxyContractAddress, chainId, signer) as BCakeProxy
}
